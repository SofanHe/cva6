...
HD_PWD='/home/sofan/CVA6-ckf/cva6/corev_apu/fpga/ariane.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log custom_inst_cva6_with_reg.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source custom_inst_cva6_with_reg.tcl -notrace
