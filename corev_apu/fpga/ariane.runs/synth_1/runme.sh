...
HD_PWD='/home/sofan/CVA6-ckf/cva6/corev_apu/fpga/ariane.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log custom_inst_cva6_with_reg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source custom_inst_cva6_with_reg.tcl
